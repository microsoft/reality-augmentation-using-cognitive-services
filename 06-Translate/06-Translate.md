...
You’re receiving this email because you’re currently subscribed to the Translator Text API.
The Microsoft Translator Text API v3 is now available and the Translator Text API v2 will be discontinued on April 30, 2019.
